-- Fix bet_resolve function syntax and add proper authorization checks
...
COMMENT ON FUNCTION bet_resolve IS 'Resolve a bet - runs with elevated privileges. Includes authorization checks and sets resolved_by/resolved_at explicitly.';
