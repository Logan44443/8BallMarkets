...
-- Add FK constraints to Transactions and Reputation_Logs (bet_id columns)
ALTER TABLE Transactions 
  ADD CONSTRAINT fk_transactions_bet_id 
  FOREIGN KEY (bet_id) REFERENCES direct_bets(bet_id) ON DELETE SET NULL;

ALTER TABLE Reputation_Logs 
  ADD CONSTRAINT fk_reputation_logs_bet_id 
  FOREIGN KEY (bet_id) REFERENCES direct_bets(bet_id) ON DELETE SET NULL;
